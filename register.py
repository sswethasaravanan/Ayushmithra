...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Ayushmithra | Registration</title>
    <link rel="stylesheet" href="styles2.css">
     <meta name="viewport" content="width=device-width, initial-scale=1.0">
   </head>
<body>
  <div class="container">
    <div class="title">Ayushmithra</div>
    <div class="content">
      <form action="#">
        ...
        <div class="button">
          <input type="submit" value="Get New Profile">
        </div>
        <div class="signup-link">
            Welcome back to <a href="<a href="https://swetha-usersignin.streamlit.app">Signin now</a>">Signin</a>
         </div>
      </form>
    </div>
  </div>
